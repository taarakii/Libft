...
/*   Updated: 2023/02/20 16:51:39 by taaraki          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
    ...
    if (strcmp(s1, elem1->content))
	printf("\ndiffers");
    if (strcmp(s2, elem2->content))
	printf("\ndiffers");
    if (strcmp(s3, elem3->content))
	printf("\ndiffers");
    if (strcmp(s4, elem4->content))
	printf("\ndiffers");
    if (strcmp(s5, elem5->content))
	printf("\ndiffers");
